...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 py-12 px-4">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-800">Create Stock Withdrawal</h1>
            <p class="text-gray-600 mt-2">Remove stock for damage, expiry, waste, or internal use</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <form action="{{ route('stock-withdrawal.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="reason" required class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('reason') border-red-500 @enderror">
                ...
                <!-- Items Section -->
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Items to Withdraw</h2>
                    <div id="items-container">
                        <div class="item mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Product</label>
                                    <select name="items[0][product_id]" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="items[0][quantity]" placeholder="0" min="1" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Unit Price</label>
                                    <input type="number" name="items[0][unit_price]" placeholder="0.00" min="0" step="0.01" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" placeholder="Additional details..." rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('stock-withdrawal.index') }}" class="bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400">
                        Cancel
                    </a>
                </div>
            </form>
...
document.getElementById('add-item').addEventListener('click', function() {
    ...
    newItem.innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Quantity</label>
                <input type="number" name="items[${itemIndex}][quantity]" placeholder="0" min="1" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Unit Price</label>
                <input type="number" name="items[${itemIndex}][unit_price]" placeholder="0.00" min="0" step="0.01" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
            </div>
            <div class="flex items-end">
                <button type="button" class="w-full bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 remove-item">Remove</button>
            </div>
