    ...
    <x-slot name="header">
        <div class="flex justify-between items-end border-b-2 border-sienna pb-4">
            <div>
                ...
                <p class="font-inter text-sage mt-1 font-medium uppercase tracking-wider text-xs">{{ $supplier->suppliers_company }}</p>
            </div>
        </div>
    </x-slot>

    <div class="card-rustic border-sienna max-w-4xl mx-auto mt-8">
        <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <x-text-input id="suppliers_company" type="text" name="suppliers_company" value="{{ old('suppliers_company', $supplier->suppliers_company) }}" class="mt-1 block w-full !text-sm" required />
                ...
                <div>
                    ...
                    <x-text-input id="suppliers_name" type="text" name="suppliers_name" value="{{ old('suppliers_name', $supplier->suppliers_name) }}" class="mt-1 block w-full !text-sm" required />
                ...
                <div>
                    ...
                    <x-text-input id="suppliers_phone" type="text" name="suppliers_phone" value="{{ old('suppliers_phone', $supplier->suppliers_phone) }}" class="mt-1 block w-full !text-sm" />
                ...
                <div>
                    ...
                    <x-text-input id="suppliers_email" type="email" name="suppliers_email" value="{{ old('suppliers_email', $supplier->suppliers_email) }}" class="mt-1 block w-full !text-sm" />
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="suppliers_address" name="suppliers_address" rows="3" class="input-artisan mt-1">{{ old('suppliers_address', $supplier->suppliers_address) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="items_supplied" name="items_supplied" rows="3" class="input-artisan mt-1">{{ old('items_supplied', $supplier->items_supplied) }}</textarea>
            ...
            <div class="flex justify-between items-center pt-8 border-t border-sienna border-opacity-10">
                <a href="{{ route('suppliers.show', $supplier->id) }}" class="text-xs font-black text-sage uppercase tracking-widest hover:text-sienna transition">
                    Back to Profile
                </a>
