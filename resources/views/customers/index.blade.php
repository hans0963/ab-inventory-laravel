    ...
    <x-slot name="header">
        <div class="flex justify-between items-end border-b-2 border-sienna pb-4">
            <div>
                ...
                <p class="font-inter text-sage mt-1 font-medium uppercase tracking-wider text-xs">Manage your bakeshop's loyal customers</p>
            </div>
                    ...
                    <tbody class="divide-y divide-sienna divide-opacity-10 bg-white">
                        @forelse ($customers as $customer)
                            <tr class="hover:bg-cream hover:bg-opacity-20 transition-colors">
                                <td class="px-6 py-5 font-bold text-sienna opacity-60">#{{ $customer->id }}</td>
